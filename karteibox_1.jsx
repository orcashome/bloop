...
/* Silbentrennung mit Bremse. hyphens:auto allein trennte "Nahrungsbausteine"
   zu "Nah-rungsbausteine" - drei Buchstaben vor dem Strich lesen sich wie ein
   Fehler. hyphenate-limit-chars sagt: erst ab 10 Zeichen trennen, und dann
   mindestens vier Buchstaben auf jede Seite. Ohne Trennung gar nicht geht auch
   nicht - deutsche Komposita sprengen sonst die Karte.
   text-wrap:pretty verhindert zusaetzlich einzelne Woerter auf der letzten
   Zeile; Browser ohne Unterstuetzung ignorieren beides stillschweigend. */
.face .term, .face .answer{ width:100%; min-height:0; max-height:100%; overflow-y:auto;
  overscroll-behavior:contain; -webkit-overflow-scrolling:touch;
  padding:2px 2px 4px; overflow-wrap:break-word;
  hyphens:auto; -webkit-hyphens:auto;
  hyphenate-limit-chars:10 4 4; -webkit-hyphenate-limit-chars:10 4 4;
  text-wrap:pretty; }
...
const CATALOG = [
  ...
  /* Gemeinsam gruseln: Marcs Wunsch fuer Uebernachtungspartys. Der Reiz haengt
   * daran, dass NICHTS erfunden ist - deshalb steht hinter jeder Karte, warum
   * es stimmt, und zwei Karten raeumen ausdruecklich mit Gruselmythen auf.
   * Keine Gewalt, keine echten Aengste (kein Ertrinken, kein Einbrecher) -
   * es geht um Natur, Geschichte und den eigenen Koerper. */
  {
    category: "Zum Staunen", subject: "Gemeinsam gruseln", name: "Gruselfakten für die Übernachtungsparty", flang: "de-DE", blang: "de-DE",
    cards: P([
      ["Es gibt einen Pilz, der Ameisen fernsteuert. Was zwingt er sie zu tun?", "Sich festzubeißen und zu sterben — an genau der richtigen Stelle.",
       "Ophiocordyceps unilateralis bringt die Ameise dazu, eine Blattader in bestimmter Höhe und Feuchte zu umklammern. Dort stirbt sie, und aus ihrem Kopf wächst der Pilz. Untersuchungen zeigen: Er befällt die Muskeln, nicht das Gehirn — er fährt die Ameise wie eine Marionette."],
      ["Wie führt die Juwelwespe eine Kakerlake ab, die dreimal so groß ist wie sie?", "An der Fühlerspitze, wie an einer Leine.",
       "Sie sticht gezielt in zwei Stellen des Kakerlakengehirns. Danach kann das Tier noch laufen, will aber nichts mehr von selbst. Die Wespe führt es in ihren Bau, legt ein Ei darauf und mauert es ein."],
      ["Wie viele Tiere leben in deinem Gesicht, ohne dass du es merkst?", "Winzige Milben — bei fast jedem Erwachsenen.",
       "Demodex folliculorum sitzt in den Haarfollikeln, vor allem an Nase und Wimpern. Sie sind unter einem halben Millimeter groß, meist völlig harmlos, und man bekommt sie in den ersten Lebensjahren von anderen Menschen."],
      ["Was passiert im Bauch einer Sandtigerhai-Mutter, bevor die Jungen geboren werden?", "Das größte Junge frisst seine Geschwister.",
       "Es heißt intrauteriner Kannibalismus. Am Ende kommt pro Gebärmutterhälfte genau ein Hai zur Welt — dafür ist er schon rund einen Meter lang und praktisch von Geburt an unangreifbar."],
      ["Was frisst ein Wurm namens Osedax auf dem Meeresgrund?", "Knochen.",
       "Er hat weder Mund noch Magen. Wurzelartige Fortsätze geben Säure ab, die den Walknochen auflöst; Bakterien in seinem Körper verwerten das Fett darin. Entdeckt wurde er erst 2002."],
      ["Wie viele Menschen liegen in den Katakomben von Paris?", "Etwa sechs Millionen.",
       "Ende des 18. Jahrhunderts waren die Friedhöfe der Stadt so voll, dass sie zur Gefahr wurden. Die Gebeine wanderten nachts in stillgelegte Steinbrüche und wurden dort zu Wänden aufgeschichtet — ein kleiner Teil ist heute begehbar."],
      ["Wozu baute man im 19. Jahrhundert Särge mit Glocke und Schnur?", "Aus Angst, lebendig begraben zu werden.",
       "Die Angst hatte einen Namen: Taphephobie. Es gab mehrere Patente für solche Sicherheitssärge. Ein bestätigter Fall, in dem eine Glocke jemanden gerettet hat, ist allerdings nicht bekannt."],
      ["Warum heißt ein Käfer im Englischen deathwatch beetle, also Totenuhr?", "Sein Klopfen im Gebälk galt als Ankündigung eines Todesfalls.",
       "Der Klopfkäfer schlägt mit dem Kopf gegen das Holz, um Partner zu finden. Man hörte ihn nachts an Krankenbetten, wenn sonst alles still war — daher der Name. Er kündigt nichts an, er sucht nur jemanden."],
      ["Wachsen Haare und Fingernägel nach dem Tod weiter?", "Nein. Es sieht nur so aus.",
       "Die Haut trocknet und zieht sich zurück, dadurch treten Nägel und Bartstoppeln stärker hervor. Wachstum braucht Nährstoffe aus dem Blut — und das fließt nicht mehr. Ein Gruselklassiker, der schlicht falsch ist."],
      ["Besteht Hausstaub hauptsächlich aus abgestorbener Menschenhaut?", "Nein — der größte Teil kommt von draußen.",
       "Untersuchungen finden vor allem Bodenpartikel, Fasern aus Kleidung und Textilien, Pollen und Ruß. Hautschuppen sind dabei, aber nicht der Hauptbestandteil. Auch dieser Gruselfakt hält sich hartnäckig."],
      ["Du wachst auf und kannst dich nicht bewegen. Was ist da los?", "Schlaflähmung — eine Sicherung, die zu spät abschaltet.",
       "Im Traumschlaf legt das Gehirn die Muskeln lahm, damit man Träume nicht mitspielt. Wacht der Kopf vor dem Körper auf, liegt man wach und gelähmt da, manchmal mit Halluzinationen. Unangenehm, aber harmlos, und nach Sekunden bis Minuten vorbei."],
      ["Wonach riecht die größte Blüte der Welt, wenn sie sich öffnet?", "Nach verwestem Fleisch.",
       "Die Titanwurz heizt ihren Blütenkolben sogar auf, damit der Gestank weiter zieht. Sie lockt damit Aaskäfer und Fliegen an, die sie bestäuben. Sie blüht selten und nur ein bis zwei Tage."],
      ["Womit reinigen Ärzte manchmal Wunden, die nicht heilen wollen?", "Mit lebenden Fliegenmaden.",
       "Die Maden fressen ausschließlich abgestorbenes Gewebe und geben Stoffe ab, die Keime hemmen. Die Madentherapie ist ein zugelassenes Verfahren, kein Aberglaube — sie kam zurück, als Antibiotika bei manchen Keimen versagten."],
      ["Was macht ein frisch geschlüpftes Kuckucksjunges als Erstes?", "Es wirft die anderen Eier aus dem Nest.",
       "Es schiebt sie mit einer Mulde im Rücken über den Rand, blind und nackt. Danach lassen die Zieheltern ihre ganze Nahrung ihm zukommen — auch wenn es bald größer ist als sie selbst."],
      ["Woran ist Ötzi gestorben, der Mann aus dem Eis?", "An einem Pfeil in der Schulter.",
       "Die Pfeilspitze steckte über 5000 Jahre unentdeckt in ihm und wurde erst 2001 auf einer Röntgenaufnahme gefunden. Sie durchtrennte eine Arterie. Vorher hatte man an Erschöpfung im Schneesturm geglaubt."],
      ["Welches Tier hat die größten Augen der Welt?", "Der Koloss-Kalmar — jedes Auge größer als ein Fußball.",
       "Rund 27 Zentimeter Durchmesser. In der Tiefsee gibt es fast kein Licht; so große Augen fangen noch das schwache Leuchten von Beute und von Pottwalen ein, die ihn jagen."],
      ["Warum heißt der Vampirtintenfisch Vampyroteuthis infernalis, Vampirtintenfisch aus der Hölle?", "Wegen des Aussehens — er ist völlig harmlos.",
       "Er lebt dort, wo kaum Sauerstoff ist, und ernährt sich von herabsinkenden Resten. Statt Tinte stößt er bei Gefahr eine leuchtende Schleimwolke aus und verschwindet im Dunkeln."],
      ["Wie viele Zellen in deinem Körper sind gar nicht deine eigenen?", "Ungefähr die Hälfte.",
       "Hauptsächlich Bakterien, die meisten im Darm. Lange hieß es zehnmal so viele wie Körperzellen; eine Neuberechnung von 2016 kam auf etwa eins zu eins. Ohne sie könntest du vieles nicht verdauen."],
    ]),
  },
];
